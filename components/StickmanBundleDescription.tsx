...
export const StickmanBundleDescription: React.FC<Props> = ({ bundle }) => {
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-950 to-brand-950 p-6 sm:p-10 text-white shadow-2xl border border-slate-800">
        ...
        <div className="relative z-10 space-y-4 max-w-3xl">
          <div className="inline-flex items-center space-x-2 px-3 py-1 bg-brand-500/20 border border-brand-400/30 rounded-full text-brand-300 text-xs font-black uppercase tracking-wider">
            ...
            <span>Official Stickman Action Vault</span>
          </div>

          <h2 className="text-2xl sm:text-4xl font-black tracking-tight leading-tight text-white">
            🥷🔥 1,000+ STICKMAN VIRAL VIDEO BUNDLE 🔥🥷
          </h2>

          <p className="text-lg sm:text-xl font-bold text-orange-400">
            The Ultimate Stickman Content Vault 🚀
          </p>

          <p className="text-sm sm:text-base text-slate-300 leading-relaxed font-medium">
            <strong className="text-white font-bold">Want to flood your YouTube Shorts, Instagram Reels & TikTok with addictive Stickman content — without spending hours searching, recording or creating videos from scratch?</strong>
          </p>

          <p className="text-sm text-slate-300 leading-relaxed">
            Introducing the <span className="text-white font-extrabold">1,000+ Stickman Video Bundle</span> — a massive collection of entertaining Stickman action clips made specifically for short-form content creators.
          </p>

          <p className="text-sm text-slate-300 leading-relaxed">
            From epic fights and crazy stunts to funny moments, battles, explosions, parkour, weapons, challenges and satisfying Stickman animations — this bundle gives you <span className="text-brand-300 font-bold">thousands of clips ready to turn into engaging short-form content.</span>
          </p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-md space-y-4 hover:border-brand-300 transition-colors">
            ...
            <h4 className="text-lg font-black text-slate-900">1,000+ Stickman Videos</h4>
            <ul className="space-y-2 text-xs font-semibold text-slate-600">
              <li className="flex items-start space-x-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" /><span>1,000+ short-form Stickman videos</span></li>
              <li className="flex items-start space-x-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" /><span>Clips designed for YouTube Shorts, Reels & TikTok</span></li>
              ...
              <li className="flex items-start space-x-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" /><span>High-quality Stickman animations & action clips</span></li>
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-md space-y-4 hover:border-brand-300 transition-colors">
            ...
            <ul className="space-y-2 text-xs font-semibold text-slate-600">
              ...
              <li className="flex items-start space-x-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" /><span>Build your Stickman library instantly</span></li>
            </ul>
          </div>
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-slate-900 text-white space-y-6 shadow-xl border border-slate-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-slate-800/80 border border-slate-700 space-y-2">
            ...
            <p className="text-xs text-slate-300 font-medium">Stop spending hours searching for Stickman clips or wondering what to post next. Your library is already waiting.</p>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-slate-800/80 border border-slate-700 space-y-2">
            ...
            <p className="text-xs text-slate-300 font-medium">Stickman animations are highly visual, fast-paced and easy to turn into entertaining short-form videos.</p>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-slate-800/80 border border-slate-700 space-y-2">
            ...
            <p className="text-xs text-slate-300 font-medium">Great for YouTube Shorts, Reels, TikTok, Facebook Reels, animation meme pages & faceless channels.</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
          {[
            ...
            '⚔️ Stickman Battles',
            '💥 Crazy Stickman Action',
            '🔥 Stickman Challenges',
            '😱 Unexpected Moments',
            '🏹 Weapon Battles',
            '🤣 Funny Stickman Clips',
            '🚀 Stickman Stunts',
            '🏃 Stickman Parkour',
            '💀 Stickman Fails',
            '⚡ Superpower Moments',
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white border border-slate-200 space-y-6 shadow-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 text-center">
          {[
            ...
            { step: '2️⃣', title: 'GET ACCESS', desc: 'Receive your 1,000+ Stickman video bundle.' },
            ...
            { step: '5️⃣', title: 'PUBLISH 🚀', desc: 'Upload content & build your Stickman page.' },
          ].map((s, i) => (
      ...
      <div className="rounded-3xl bg-gradient-to-r from-brand-600 via-orange-600 to-amber-500 p-6 sm:p-10 text-white shadow-2xl text-center space-y-6 relative overflow-hidden">
        <div className="max-w-2xl mx-auto space-y-3 relative z-10">
          ...
          <p className="text-sm font-bold text-orange-100">
            1,000+ Stickman videos. One massive bundle. One-time payment. Lifetime access.
          </p>
          ...
          <div className="pt-2">
            {!isPurchased && bundle ? (
              ...
              >
                ...
                <span>GET THE 1,000+ STICKMAN VIDEO BUNDLE TODAY — ₹{bundle.price || 39}</span>
              </button>
            ) : (
              <a
