...
export const CarCrashBundleDescription: React.FC<Props> = ({ bundle }) => {
    ...
    <div className="space-y-10 pt-8 border-t border-slate-200 text-slate-800">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-950 to-brand-950 p-6 sm:p-10 text-white shadow-2xl border border-slate-800">
        ...
        <div className="relative z-10 space-y-4 max-w-3xl">
          <div className="inline-flex items-center space-x-2 px-3 py-1 bg-brand-500/20 border border-brand-400/30 rounded-full text-brand-300 text-xs font-black uppercase tracking-wider">
            ...
            <span>Official BeamNG Crash Vault</span>
          </div>

          <h2 className="text-2xl sm:text-4xl font-black tracking-tight leading-tight text-white">
            💥 8,000+ BEAMNG CAR CRASH VIDEO BUNDLE 💥
          </h2>

          <p className="text-lg sm:text-xl font-bold text-orange-400">
            The Ultimate Viral Crash Content Vault 🚗💥
          </p>

          <p className="text-sm sm:text-base text-slate-300 leading-relaxed font-medium">
            <strong className="text-white font-bold">Want to flood your YouTube Shorts, Instagram Reels & TikTok with addictive car crash content — without spending hours recording and editing?</strong>
          </p>

          <p className="text-sm text-slate-300 leading-relaxed">
            Introducing the <span className="text-white font-extrabold">8,000+ BeamNG.drive Car Crash Video Bundle</span> — a massive collection of high-impact, physics-based crash clips made for short-form content creators.
          </p>

          <p className="text-sm text-slate-300 leading-relaxed">
            From insane collisions and realistic vehicle destruction to unexpected crashes and satisfying physics moments — this bundle gives you <span className="text-brand-300 font-bold">thousands of clips ready to turn into engaging short-form content.</span>
          </p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1: 8000+ BeamNG Crash Shorts */}
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-md space-y-4 hover:border-brand-300 transition-colors">
            ...
            <h4 className="text-lg font-black text-slate-900">8,000+ BeamNG Crash Shorts</h4>
            <ul className="space-y-2 text-xs font-semibold text-slate-600">
              <li className="flex items-start space-x-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" /><span>8,000+ short-form BeamNG.drive clips</span></li>
              <li className="flex items-start space-x-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" /><span>Clips designed for Shorts, Reels & TikTok</span></li>
              ...
              <li className="flex items-start space-x-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" /><span>Realistic physics-based crashes</span></li>
              <li className="flex items-start space-x-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" /><span>Smooth, high-quality visuals</span></li>
          ...
          {/* Card 2: Organized Google Drive Access */}
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-md space-y-4 hover:border-brand-300 transition-colors">
            <div className="w-10 h-10 rounded-2xl bg-brand-100 text-brand-600 flex items-center justify-center font-black">
              📂
            </div>
            <h4 className="text-lg font-black text-slate-900">ORGANIZED GOOGLE DRIVE ACCESS</h4>
            <ul className="space-y-2 text-xs font-semibold text-slate-600">
              <li className="flex items-start space-x-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" /><span>Easy-to-navigate folders</span></li>
              ...
              <li className="flex items-start space-x-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" /><span>Download only what you need</span></li>
              <li className="flex items-start space-x-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" /><span>Access your content whenever you want</span></li>
            </ul>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-md space-y-4 hover:border-brand-300 transition-colors">
            ...
            <p className="text-xs font-bold text-slate-500">Turn every clip into your own content. Add:</p>
            <ul className="space-y-1.5 text-xs font-semibold text-slate-600">
              ...
              <li>🎨 Your branding</li>
              <li>💥 Sound effects</li>
              <li>🎬 Your own editing style</li>
            </ul>
            <p className="text-[11px] font-bold text-brand-600 pt-1">Create multiple variations from the same footage and build a consistent content pipeline.</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-slate-900 text-white space-y-6 shadow-xl border border-slate-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-slate-800/80 border border-slate-700 space-y-2">
            ...
            <h5 className="font-extrabold text-white text-xs uppercase">Save Hundreds of Hours</h5>
            <p className="text-xs text-slate-300 font-medium">No need to spend hours recording crashes, setting up scenarios or searching for clips. Your library is ready.</p>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-slate-800/80 border border-slate-700 space-y-2">
            ...
            <h5 className="font-extrabold text-white text-xs uppercase">Built for Short-Form Content</h5>
            <p className="text-xs text-slate-300 font-medium">BeamNG crash videos are naturally eye-catching and easy to understand — making them ideal for fast-scrolling audiences.</p>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-slate-800/80 border border-slate-700 space-y-2">
            ...
            <p className="text-xs text-slate-300 font-medium">One-time purchase of ₹39. No monthly subscription. No recurring fees. Buy once → Download → Create → Publish.</p>
          </div>

          <div className="p-5 rounded-2xl bg-slate-800/80 border border-slate-700 space-y-2">
            <div className="flex items-center space-x-2 text-amber-400 font-bold text-sm">
              <DollarSign className="w-4 h-4" />
              <span>GREAT FOR CREATORS</span>
            </div>
            <h5 className="font-extrabold text-white text-xs uppercase">Ideal for Channels & Agencies</h5>
            <p className="text-xs text-slate-300 font-medium">Perfect for YouTube Shorts, Reels, TikTok, Facebook Reels, gaming pages, meme pages, faceless channels & agencies.</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
          {[
            '🚗 Impossible Car Crashes',
            '💥 Craziest BeamNG Moments',
            '🔥 Satisfying Destruction Clips',
            '😱 Unexpected Crash Scenarios',
            '🏎️ Car vs Car Challenges',
            '🚧 Extreme Road Accidents',
            '🤯 What Happens If…?',
            '🏆 Top 5 / Top 10 Compilations'
          ].map((item, idx) => (
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white border border-slate-200 space-y-6 shadow-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 text-center">
          {[
            ...
            { step: '2️⃣', title: 'GET ACCESS', desc: 'Receive your Bundle/videos after purchase.' },
      ...
      <div className="rounded-3xl bg-gradient-to-r from-brand-600 via-orange-600 to-amber-500 p-6 sm:p-10 text-white shadow-2xl text-center space-y-6 relative overflow-hidden">
        <div className="max-w-2xl mx-auto space-y-3 relative z-10">
          ...
          <p className="text-sm font-bold text-orange-100">
            Thousands of crash clips. One massive bundle. One-time payment. Lifetime access.
          </p>
          ...
          <div className="pt-2">
            {!isPurchased && bundle ? (
              ...
              >
                ...
                <span>GET THE 8,000+ BEAMNG CRASH VIDEO BUNDLE TODAY — ₹{bundle.price || 39}</span>
              </button>
            ) : (
              <a
                href={bundle?.driveUrl || 'https://drive.google.com/drive/folders/1BEUAM2fnKo6drhy6P42mrM6sBTNWqWbV'}
                target="_blank"
